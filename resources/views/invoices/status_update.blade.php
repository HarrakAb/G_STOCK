                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="Section" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    <!--placeholder-->
                                    <option value=" {{ $invoices->categorie->id }}">
                                        {{ $invoices->categorie->categorie_name }}
                                    </option>
                            ...
                            <div class="col">
                                ...
                                <select id="article" name="article" class="form-control" readonly>
                                    <option value="{{ $invoices->article }}"> {{ $invoices->article }}</option>
                                </select>
                            </div>
