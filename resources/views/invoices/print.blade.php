...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Les bons</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                ...
                <div class="card card-invoice">
                    <div class="card-body">
                        <div class="invoice-header">
                            <h1 class="invoice-title">Bon entree</h1>
                        ...
                        <div class="table-responsive mg-t-40">
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tbody>
                                    {{-- <tr>
                                        <td>1</td>
                                        <td class="tx-12">{{ $invoices->article }}</td>
