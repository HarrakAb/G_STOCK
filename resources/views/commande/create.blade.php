                    ...
                    <form id="bon" action="{{ route('commande.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="client_credit" title="entrée le numéro de votre bon"
                                    value="100.00" required readonly>
                                @error('bon_number')<span
                            ...
                            <div class="row line" id="1">
                                ...
                                <div class="col-md-6">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col">
                                            <div class="input-group">
                                                <input type="hidden" name="description_id" class="description_id"
                                                    id="description_id" value="1">
                                                <input type="text" name="description[]" class="form-control description"
                                                    id="description1" readonly required />
                                        ...
                                        <div class="col">
                                            <div class="input-group">
                                                ...
                                                <input type="number" value="{{ old('quantite[]') }}" name="quantite[]"
                                                    class="form-control quantite" id="quantite" required />
                                                @error('quantite')<span
                                                    class="help-block text-danger">{{ $message }}</span>@enderror
                                            </div>
                                        </div>
    ...
    <script>
        ...
        $('.addRow').on('click', function() {
            ...
            var div = '<div class="row line" id="' + numberOfRow + '">' +
                ...
                '<div class="col">' +
                '<div class="input-group">' +
                '<input type="hidden" name="description_id" class="description_id"  id="description_id" value="'+numberOfRow+'">' +
                '<input type="text" data-description_id="' + numberOfRow +
                '" name="description[]" class="form-control description" id="description' + numberOfRow +
                '" readonly required/>' +
