...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Les utilisateurs</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ modifié un utilisateur
                </span>
        </div>
    </div>
</div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mg-b-20">
                    ...
                    <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                        <label> Confirme Mot de Passe: <span class="tx-danger">*</span></label>
