                ...
                <form action="/Search_customers" method="POST" role="search" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <select name="categorie" class="form-control select2" onclick="console.log($(this).val())"
                                onchange="console.log('change is firing')">
                                <!--placeholder-->
                                <option value="" selected disabled>حدد القسم</option>
                                @foreach ($categories as $categorie)
                                    <option value="{{ $categorie->id }}"> {{ $categorie->scategorie_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                            ...
                            <select id="article" name="article" class="form-control select2">
                            ...
                            <tbody>
                                ...
                                @foreach ($details as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td><a
                                                href="{{ url('InvoicesDetails') }}/{{ $invoice->id }}">{{ $invoice->categorie->categorie_name }}</a>
                                        </td>
            ...
            if (categorieId) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('select[name="article"]').append('<option value="all"> All</option>');
