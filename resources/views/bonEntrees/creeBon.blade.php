...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Les Bons d'Entrer</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">
                     Ajouter un Bon d'Entrer</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('bonEntrees.store') }}" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        {{ csrf_field() }}
                        {{-- 1 --}}
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label>Date d'entrée du Bon</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="inputName" class="control-label">: Réceptionné par</label>
        ...
        function myFunction() {
           ...
           // var Value_VAT = parseFloat(document.getElementById("Value_VAT").value);
            ...
            if (typeof quantite === 'undefined' || !quantite) {
                ...
                //var intResults = quantite * prix_unitaire ;
