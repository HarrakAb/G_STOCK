                        ...
                        <div class="row mt-2">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="bon_number"
                                    title="entrée le numéro de votre bon" value="{{ old('bon_number' , $bonEntrees->bon_number )}}" readonly required>
                            ...
                            <table id="example1" class="table table-bordred key-buttons text-md-nowrap"
                                ...
                                <tbody class="addMoreArticle">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:15%">
                                            <input type="number" value="" name="total_quantite[]" class="form-control total_quantite" id="total_quantite" readonly required/>
